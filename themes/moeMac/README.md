...
本地化的库包括：APlayer、Meting、KaTeX、Mermaid、Masonry、Font Awesome、Gitalk、Waline、Twikoo、CWD、卜算子。

> 唯一的外部引用是 Giscus 评论系统的 `giscus.app/client.js`（官方要求，不可本地化）。Hitokoto / Meting API 属于实时数据接口，非静态资源。
...
Hexo + EJS · 原生 CSS + CSS 变量 · CSS @keyframes + Web Animations API · APlayer + Meting · KaTeX · Mermaid · Masonry · Font Awesome · 内联 SVG 社交图标
...
[Hexo](https://hexo.io) · [APlayer](https://aplayer.js.org) + [MetingJS](https://github.com/metowolf/MetingJS) · [KaTeX](https://katex.org) · [Mermaid](https://mermaid.js.org) · [Masonry](https://masonry.desandro.com) · [Font Awesome](https://fontawesome.com) · [Giscus](https://giscus.app) · [CWD](https://cwd.js.org/)
